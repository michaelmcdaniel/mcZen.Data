...
namespace mcZen.Data.MySql
{
	...
	public static class Queries
	{
		...
		public static string ParametersToString(IEnumerable<MySqlParameter> parameters)
		{
			StringBuilder retVal = new StringBuilder();
			foreach (var sp in parameters)
			{
				retVal.AppendFormat("{2}:{0}=\"{1}\"\r\n", sp.ParameterName, (sp.Value == null || sp.Value == DBNull.Value) ? "NULL" : sp.Value, sp.MySqlDbType);
			}
