...
namespace mcZen.Data.MySql
{
	public static class SqlDataReaderExtensions
	{
		...
		public static T GetValue<T>(this MySqlDataReader reader, string column, T defaultValue)
		{
		...
		public static T GetValue<T>(this MySqlDataReader reader, int columnIndex, T defaultValue)
		{
		...
		public static Nullable<T> GetValue<T>(this MySqlDataReader reader, string column) where T : struct
		{
			object value = reader[column];
			if (value == DBNull.Value)
				return null;
		...
		public static Nullable<T> GetValue<T>(this MySqlDataReader reader, int columnIndex) where T : struct
		{
		...
		public static DateTime GetValue(this MySqlDataReader reader, string column, DateTime defaultValue, DateTimeKind kind)
		{
			object value = reader[column];
			if (value == DBNull.Value)
				return defaultValue;
		...
		public static DateTimeOffset GetValue(this MySqlDataReader reader, string column, DateTimeOffset defaultValue)
		{
			object value = reader[column];
			if (value == DBNull.Value)
				return defaultValue;
		...
		public static DateTimeOffset GetValue(this MySqlDataReader reader, string column, DateTimeOffset defaultValue, TimeZoneInfo tz)
		{
		...
		public static string GetValue(this MySqlDataReader reader, string column, string defaultValue, bool defaultIfEmpty)
		{
		...
		public static T GetEnum<T>(this MySqlDataReader reader, string column, T defaultValue)
		{
			object value = reader[column];
			if (value == DBNull.Value)
				return defaultValue;
