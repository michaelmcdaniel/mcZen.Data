...
namespace mcZen.Data.MySql
{
	...
	public class CommandReader : Command
	{
		...
		private Func<MySqlDataReader, System.Threading.Tasks.Task<bool>> _ReadFunc;
		private event OnCompleteEventHandler _OnComplete;

		public CommandReader(string query, params MySqlParameter[] parameters)
			: base(query, parameters) { _ReadFunc = Read; }

		public CommandReader(string query, CommandType type, params MySqlParameter[] parameters)
			: base(query, type, parameters) { _ReadFunc = Read; }

		public CommandReader(string query, CommandType type, TimeSpan timeout, params MySqlParameter[] parameters)
			: base(query, type, timeout, parameters) { _ReadFunc = Read; }

		public CommandReader(string query, CommandType type, int timeout, params MySqlParameter[] parameters)
			: base(query, type, timeout, parameters) { _ReadFunc = Read; }
		...
		public CommandReader(Func<MySqlDataReader, bool> func, string query, params MySqlParameter[] parameters)
		...
		/// <param name="parameters">sql parameters to pass with query</param>
		public CommandReader(Func<MySqlDataReader, bool> func, string query, CommandType type, TimeSpan timeout, params MySqlParameter[] parameters)
		...
		/// <param name="timeout">Timeout for the query to execute in.</param>
		/// <param name="parameters">sql parameters to pass with query</param>
		public CommandReader(Func<MySqlDataReader, bool> func, string query, CommandType type, int timeout, params MySqlParameter[] parameters)
			: base(query, type, timeout, parameters) { _ReadFunc = (r) => Task.FromResult(func(r)); }
		...
		/// <param name="timeout">Timeout for the query to execute in.</param>
		/// <param name="parameters">sql parameters to pass with query</param>
		public CommandReader(Func<MySqlDataReader, Task<bool>> func, string query, CommandType type, TimeSpan timeout, params MySqlParameter[] parameters)
		...
		/// <param name="timeout">Timeout for the query to execute in.</param>
		/// <param name="parameters">sql parameters to pass with query</param>
		public CommandReader(Func<MySqlDataReader, Task<bool>> func, string query, CommandType type, int timeout, params MySqlParameter[] parameters)
			: base(query, type, timeout, parameters) { _ReadFunc = func; }
		...
		/// <param name="timeout">Timeout for the query to execute in.</param>
		/// <param name="parameters">sql parameters to pass with query</param>
		public CommandReader(Action<MySqlDataReader> action, string query, CommandType type, TimeSpan timeout, params MySqlParameter[] parameters)
		...
		/// <param name="timeout">Timeout for the query to execute in.</param>
		/// <param name="parameters">sql parameters to pass with query</param>
		public CommandReader(Action<MySqlDataReader> action, string query, CommandType type, int timeout, params MySqlParameter[] parameters)
			: base(query, type, timeout, parameters) { _ReadFunc = (a) => { action(a); return Task.FromResult(true); }; }
		...
		/// <param name="timeout">Timeout for the query to execute in.</param>
		/// <param name="parameters">sql parameters to pass with query</param>
		public CommandReader(Func<MySqlDataReader, Task> action, string query, CommandType type, TimeSpan timeout, params MySqlParameter[] parameters)
		...
		/// <param name="timeout">Timeout for the query to execute in.</param>
		/// <param name="parameters">sql parameters to pass with query</param>
		public CommandReader(Func<MySqlDataReader, Task> action, string query, CommandType type, int timeout, params MySqlParameter[] parameters)
			: base(query, type, timeout, parameters) { _ReadFunc = async (a) => { await action(a); return true; }; }
		...
		protected virtual System.Threading.Tasks.Task<bool> Read(MySqlDataReader reader)
		{
